...
const Navbar = () => {
  ...
  const ITEMS = [
    ...
    { label: 'Panduan', href: '/docs/ANALYTICS_USER_GUIDE.pdf' },
    { label: 'FAQ', href: '/faq' },
  ];
        ...
        <div className="flex w-full items-center justify-between px-3.5 lg:px-6">
          ...
          <Link href="/" className="flex items-center gap-2">
            <Image
              ...
              width={129}
              height={32}
              className="dark:invert" style={{ width: "129px", height: "auto" }}
            />
          </Link>
          ...
          <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 block w-[18px] -translate-x-1/2 -translate-y-1/2">
                <span
                  aria-hidden="true"
                  className={`absolute block h-0.5 w-full rounded-full bg-foreground transition duration-500 ease-in-out ${isMenuOpen ? 'rotate-45' : '-translate-y-1.5'}`}
                ></span>
                <span
                  aria-hidden="true"
                  className={`absolute block h-0.5 w-full rounded-full bg-foreground transition duration-500 ease-in-out ${isMenuOpen ? 'opacity-0' : ''}`}
                ></span>
                <span
                  aria-hidden="true"
                  className={`absolute block h-0.5 w-full rounded-full bg-foreground transition duration-500 ease-in-out ${isMenuOpen ? '-rotate-45' : 'translate-y-1.5'}`}
